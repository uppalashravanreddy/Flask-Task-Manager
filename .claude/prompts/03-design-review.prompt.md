...
3. Write `.claude/artifacts/<TICKET-ID>/design-review.md` with:
...
5. Commit both files: `git add .claude/artifacts/<TICKET-ID>/ && git commit -m "docs(<TICKET-ID>): Phase 3 design review + architecture corrections"`
