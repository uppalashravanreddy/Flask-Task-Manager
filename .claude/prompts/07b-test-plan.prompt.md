...
## Input
`docs/artifacts/<TICKET-ID>/test-strategy.md` and `docs/artifacts/<TICKET-ID>/requirements.md`.
...
2. Check environment readiness:
   ...
   ```
3. Write `docs/artifacts/<TICKET-ID>/test-plan.md` with:
...
5. Commit: `git add docs/artifacts/<TICKET-ID>/test-plan.md && git commit -m "docs(<TICKET-ID>): Phase 7.2 test plan"`
