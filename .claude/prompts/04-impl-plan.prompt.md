...
4. Write `docs/artifacts/<TICKET-ID>/impl-plan.md` with:
...
5. Commit: `git add docs/artifacts/<TICKET-ID>/impl-plan.md && git commit -m "docs(<TICKET-ID>): Phase 4 implementation plan"`
